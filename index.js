...
// const MailchimpSubscription = require('./graphqlSchema/MailchimpSubscription');
// const SendGridEmail = require('./graphqlSchema/SendGridEmail');
...
const schema = makeExecutableSchema({
  ...
  typeDefs: [
    ...
    // MailchimpSubscription.typeDefs,
    // SendGridEmail.typeDefs,
  ...
  resolvers: merge(
    ...
    // MailchimpSubscription.resolvers,
    // SendGridEmail.resolvers,
